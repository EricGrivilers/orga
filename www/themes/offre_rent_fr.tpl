<page>
    ...
    <table style="width:{mWidth}mm" >
      <tr>
        <td style='width:{mWidth}mm;text-align:center'>Conditions générales applicables pour la vente et la location de nos produits en annexe de cette offre.</td>
      </tr>
      <tr>
  ...
  <table style="width:{mWidth}mm" >
    <tr>
      <td style='width:{mWidth}mm;background-color:#ededed;text-align:center'><b>Offre de location</b></td>
    </tr>
  </table>
  <p>{introText}</p>
 <br/>
...
<page>
  ...
  <table style="width:{mWidth}mm" >
    <tr>
      <td style='width:{mWidth}mm;background-color:#ededed;text-align:center'><b>Offre de prix de location</b></td>
    </tr>
  </table>
  <br/>
  <br/>
