<page>
    ...
    <table style="width:{mWidth}mm" >
      <tr>
        <td style='width:{mWidth}mm;text-align:center'>General conditions appropiate the sales or rental of our products as mentioned in the annex of this offer.</td>
      </tr>
      <tr>
  ...
  <table style="width:{mWidth}mm" >
    <tr>
      <td style='width:{mWidth}mm;background-color:#ededed;text-align:center'><b>Rental proposal</b></td>
    </tr>
  </table>
  <p>{introText}</p>
 <br/>
  ...
  <b><u>Timing :</u></b>
  <ul>
    <li>Build : {timingBuild}</li>
    <li>Event : {timingInPlace}</li>
    <li>Unbuild : {timingUnbuild}</li>
  </ul>
  <br/>
  <b><u>Rental – proposal :</u></b> {tents} <br/>
...
<page>
  ...
  <table style="width:{mWidth}mm" >
    <tr>
      ...
      <td style="width:90mm;vertical-align:bottom;text-align:right">Offer {offreRef} (p2)</td>
    </tr>
  </table>
  <br/>
  <table style="width:{mWidth}mm" >
  ...
  <b><u>Conditions :</u></b>
  <p>{conditions}</p>
  <p> <b>Our prices are vat exclusive</b> <br/>
    Validity of this offer: 30 days</p>
  <br />
  <br />
