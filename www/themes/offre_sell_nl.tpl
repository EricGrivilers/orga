<page>
  ...
  <table style="width:{mWidth}mm" >
    <tr>
      <td style='width:{mWidth}mm;background-color:#ededed;text-align:center'><b>Verkoop – voorstel</b></td>
    </tr>
  </table>
  <p>{introText}</p>
 <br/>
  ...
  <b><u>Timing :</u></b>
  <ul>
    <li>Opbouw : {timingBuild}</li>
    <li>Event : {timingInPlace}</li>
    <li>Afbouw : {timingUnbuild}</li>
  </ul>
  <br/>
  <b><u>Verkoop – voorstel :</u></b> {tents} <br/>
  
  <page_footer>
    <table style="width:{mWidth}mm" >
      <tr>
        <td style='width:{mWidth}mm;text-align:center'>Algemene voorwaarden die geldig zijn voor de aankoop of huur van onze produkten zoals vermeld bij de annex van deze offerte</td>
      </tr>
      <tr>
        <td style='width:{mWidth}mm;background-color:#ededed;text-align:center'>Organic sa - Mechelsesteenweg, 366 - 1950 Kraainem - Belgium<br/>
          ...
          Bank account: 001-5712962-29 - IBAN : BE26001571296229 - SWIFT : GEBABEBB<br/>
...
<page>
  <table style="width:{mWidth}mm" >
    <tr>
      <td style="width:80mm;vertical-align:top"><img src="images/logo.png"></td>
      <td style="width:100mm;vertical-align:bottom;text-align:right">Offerte {offreRef} (p2)</td>
    </tr>
  </table>
  <br/>
  <table style="width:{mWidth}mm" >
  ...
  <p>{conditions}</p>
  <p> <b>Onze prijzen zijn exclusief btw</b> <br/>
    Geldigheid van deze offerte: 30 dagen </p>
  <br />
  <br />
  ...
  <page_footer>
    <table style="width:190mm" >
      <tr>
        <td style='width:190mm;text-align:center'>Algemene voorwaarden die geldig zijn voor de aankoop of huur van onze produkten zoals vermeld bij de annex van deze offerte</td>
      </tr>
      <tr>
