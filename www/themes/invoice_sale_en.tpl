<page> 
  <table style="width:190mm" >
    <tr>
      <td style="width:90mm;vertical-align:top"><img src="lib/templates/default/images/logo-offre.png"><br/><br/>Facture N° {invoiceRef}<br/>Du {date}</td>
  ...
  <table style="width:190mm" >
    <tr>
      <td style='width:190mm;background-color:#ededed;text-align:center'><b>Vente</b></td>
    </tr>
  </table>
   {budget}
   <br/>
   <br/>{slices}
   <br/><br/>
   <page_footer><table style="width:190mm" >
   <tr><td style='width:190mm;text-align:center'>Conditions générales applicables pour la vente et la location de nos produits en annexe de cette facture.</td></tr>
    <tr>
...
Tel 00 32 2 720 77 45 - Fax 00 32 2 720 12 66 - info@organic-concept.com
</td>
    </tr>
  </table>
  </page_footer>
  ...
  <table style="width:190mm" >
    <tr>
      ...
      <td style="width:100mm;vertical-align:bottom;text-align:right">Facture N° {invoiceRef} (page 2)</td>
    </tr>
  </table>
   <table style="width:190mm" >
    <tr>
      <td style='width:190mm;background-color:#ededed;text-align:center'><b>Detail</b></td>
    </tr>
  </table>
   <br/>
  <b><u>Lieu :</u></b>
