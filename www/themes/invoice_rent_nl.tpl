 ...
 <table style="width:190mm;" >
    <tr>
      <td style='width:100mm;vertical-align:top'><img src="images/logo-offre.png"><br/>
        <br/>
        Factuur {invoiceRef}<br/>
        Zaventem, {date}<br/>
        <br/>
        {user}</td>
      <td style='vertical-align:top;padding-top:4mm'><span style="color:#E1001A;font-weight:bold">{reminder}Verhuur factuur</span><p style='padding-top:10mm'>{contact}</p>
