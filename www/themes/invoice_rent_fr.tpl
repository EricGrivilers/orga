 ...
 <table style="width:{mWidth}mm;" >
    ...
    <tr>
      <td style='width:100mm;vertical-align:top'><img src="images/logo.png"><br/>
        <br/>
        Facture {invoiceRef}<br/>
        Kraainem, {date}<br/>
        <br/>
        {user}</td>
      <td style='vertical-align:top;padding-top:4mm'><span style="color:#E1001A;font-weight:bold">{reminder}Facture de location</span><p style='padding-top:10mm'>{contact}</p>
