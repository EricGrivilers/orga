<page>
 ...
 <table style="width:{mWidth}mm;" >
    ...
    <tr>
      <td style='width:100mm;vertical-align:top'><img src="images/logo.png"><br/>
        <br/>
       
        Kraainem, {date}<br/>
        <br/>
        {user}</td>
      <td style='vertical-align:top;padding-top:4mm'><span style="color:#E1001A;font-weight:bold">1er RAPPEL - Facture de location</span><p style='padding-top:10mm'>{contact}</p>
...
<p>Votre compte en nos livres présente un solde en notre faveur dont vous trouverez le détail ci-dessous.</p> 

<p>Nous vous remercions dès lors d’effectuer le paiement dès réception de la présente sur notre compte en mentionnant le(s) numéro(s) de facture.<br/> 

Dans le cas où votre règlement aurait été adressé entre temps, nous vous prions de ne pas tenir compte de la présente.</p>
 ...
 <table style="width:{mWidth}mm;border:1px solid #000000;" cellspacing='0' >
 	<tr >
 		<td style='padding:2mm;border-bottom:1px solid #000000;border-right:1px solid #000000'>FACTURE</td>
 		<td style='padding:2mm;border-bottom:1px solid #000000;border-right:1px solid #000000'>DATE</td>
		<td style='padding:2mm;border-bottom:1px solid #000000;border-right:1px solid #000000'>MONTANT</td>
 		<td style='padding:2mm;border-bottom:1px solid #000000;border-right:1px solid #000000'>MONTANT TVAC</td>
 		<td style='padding:2mm;border-bottom:1px solid #000000;border-right:1px solid #000000'>ECHEANCE</td>
		<td style='padding:2mm;border-bottom:1px solid #000000'>CONDITIONS PAIEMENT</td>
 		
 	</tr>
 	<tr>
 		<td style='padding:2mm;border-right:1px solid #000000'>{invoiceRef}</td>
 		<td style='padding:2mm;border-right:1px solid #000000'>{invoiceDate}</td>
		<td style='padding:2mm;border-right:1px solid #000000;text-align:right'>{priceHT} €</td>
 		<td style='padding:2mm;border-right:1px solid #000000;text-align:right'>{priceTTC}</td>
 		<td style='padding:2mm;border-right:1px solid #000000'>{invoiceDate}</td>
		<td style='padding:2mm;'>COMPTANT</td>
