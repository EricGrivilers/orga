...
<p>La facture n°{invoiceRef} n’est pas payée à ce jour, la date d’échéance étant datée au {invoiceDate}.</p>
<p>Nous vous remercions d’effectuer le paiement dès réception de la présente sur notre compte. Dans le cas contraire, nous serons obligés de vous facturer des frais supplémentaires de 15 %.</p>
