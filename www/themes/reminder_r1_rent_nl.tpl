 ...
 <table style="width:190mm;" >
    <tr>
      <td style='width:100mm;vertical-align:top'><img src="images/logo.png"><br/>
        ...
        <br/>
        {user}</td>
      <td style='vertical-align:top;padding-top:4mm'><span style="color:#E1001A;font-weight:bold">Betalingsherinnering</span><p style='padding-top:10mm'>{contact}</p>
...
<p>Hieronder, vindt u een rekeningoverzicht van de vervallen facturen.</p>

<p>Daar wij tot op heden geen betaling hebben mogen ontvangen, verzoeken wij u dringend tot betaling over te gaan van het openstaande bedrag.<br/>

Mocht u inmiddels tot betaling zijn overgegaan, dan mag u deze herinnering als niet verzonden beschouwen.</p>
