 ...
 <table style="width:{{mWidth}}mm;" >
    ...
    <tr>
      <td style='width:100mm;vertical-align:top'><img src="themes/default/images/logo.png"><br/>
        ...
        Zaventem, le {{invoice.medRDate}}<br/>
        <br/>
       </td>
      <td style='vertical-align:top;padding-top:4mm'><span style="color:#E1001A;font-weight:bold">MISE EN DEMEURE - 
...
<p>N’ayant pas réceptionné le paiement de cette facture, nous sommes obligés de vous facturer des frais supplémentaires de 15 %. </p>
 ...
 <table style="width:{mWidth}mm;border:1px solid #000000;" cellspacing='0' >
 	...
 	<tr>
		...
		<td style='padding:2mm;'>TOTAL A PAYER</td>
