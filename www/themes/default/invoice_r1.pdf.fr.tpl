 ...
 <table style="width:{{mWidth}}mm;" >
    ...
    <tr>
      <td style='width:100mm;vertical-align:top'><img src="themes/default/images/logo.png"><br/>
        <br/>
        Facture {{invoice.reference}}<br/>
        Kraainem, le {{invoice.r1RDate}}<br/>
        <br/>
       </td>
      <td style='vertical-align:top;padding-top:4mm'><span style="color:#E1001A;font-weight:bold">1er RAPPEL - 
...
Dans le cas où votre règlement aurait été adressé entre temps, nous vous prions de ne pas tenir compte de la présente.</p>
 ...
 <table style="width:{mWidth}mm;border:1px solid #000000;" cellspacing='0' >
 	...
 	<tr>
 		...
 		{% if invoice.jobId>0 %}
		<td style='padding:2mm;border-right:1px solid #000000;text-align:right'>{{slice.priceHT}}  €</td>
 		{% else %}
 		<td style='padding:2mm;border-right:1px solid #000000;text-align:right'>{{invoice.priceHT}}  €</td>
 		{% endif %}
