    ...
    <tr>
      ...
      <td style='vertical-align:top;padding-top:4mm'><span style="color:#E1001A;font-weight:bold">{{reminder}} 
      	...
      	{% if invoice.creditNote %} 
      		<br/>voor factuur {{invoice.creditNote}}
      		{% endif %} 
      	</span>
   ...
   {% if invoice.jobId>0 %}
				...
				<table style="width:180mm">
					...
					<tbody>
						...
						<tr>
							<td></td>
							<td></td>
							<td style="text-align:right;">BTW : {{sliceTVA}}</td>
						</tr>
				...
				<table style='border:1px solid #000;width:180mm;font-weight:bold'>
					<tbody><tr>
							...
							TOTAAL incl BTW {% if grandTotal>0 %}te betalen {% endif %}:<b> {{grandTotal}} €</b>
...
Communicatie: factuur nummer<br/>
  {% endif %}
   ...
   De betaling van uw voorschot, bevestigt uw bestelling.<br/>
  {% endif %}
