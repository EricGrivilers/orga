<page>
	...
	<table style="width:180mm" >
		<tr>
			<td style='width:180mm;background-color:#ededed;text-align:center'><b>Offre {% if offre.offreType=='rent' %} de location {% elseif offre.offreType=='winter' %} d'hivernage {% else %} de vente {% endif %}</b></td>
		</tr>
	</table>
	<p>
	...
	<ul>
		<li>
			Montage : {{offre.fStartBuild}}
		</li>
		{% if planning.inplace.formatedStartDate!='0000-00-00 00:00:00' %}
		<li>
			Jour(s) de votre evénement : du {{planning.inplace.formatedStartDate}} au {{planning.inplace.formatedEndDate}}
		</li>
		{% endif %}
		<li>
			Démontage : {{offre.fEndBuild}}
		</li>
	</ul>
	<br/>
...
<page>
	...
	<table style="width:180mm" >
		<tr>
			...
			<td style="width:90mm;vertical-align:bottom;text-align:right">Offre {{offre.reference}} (p2)</td>
		</tr>
	</table>
	<br/>
	<table style="width:180mm" >
	...
	<table style='width:180mm'>
		...
		<tfoot >
			...
			<tr>
				<td style='text-align:right;width:80%'>Total HTVA</td><td style='width:20%;text-align:right'><b>{{productsTotal}} €</b></td>
			</tr>
			<tr>
				<td style='text-align:right;width:80%'>TVA (21%)</td><td style='width:20%;text-align:right'>{% if offre.priceType=='intra' %}intra communautaire{% else %}{{productsTotalTVA}} €{% endif %}</td>
			</tr>
			<tr>
				<td style='text-align:right;width:80%;background-color:#ededed;'><b>TOTAL TTC à payer</b></td><td style='width:20%;text-align:right;background-color:#ededed;'><b>{{productsTotalTTC}} €</b></td>
			</tr>
			</tfoot >
	</table>
	{% endif %}
	<br/>
	<br/>
	{% if productOptions %} <b><u>Options :</u></b>
	<br/>
	<table style='width:180mm'>
		<thead style='border-bottom:1px solid #000000;background-color:#ededed;'>
			<tr>
	...
	{{offre.conditions}}
	{% else %}
	La réservation sera prise en compte à la reception de votre accompte
	{% endif %}
	<p>
