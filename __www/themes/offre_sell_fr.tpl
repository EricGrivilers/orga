<page>
  ...
  <table style="width:{mWidth}mm" >
    <tr>
      <td style='width:{mWidth}mm;background-color:#ededed;text-align:center'><b>Offre de vente</b></td>
    </tr>
  </table>
  <p>{introText}</p>
 <br/>
  ...
  <br/>
  <b><u>Proposition de tente(s) :</u></b> {tents} <br/>
