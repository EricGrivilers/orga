<page>
    ...
    <table style="width:{{mWidth}}mm" >
      <tr>
        <td style='width:{{mWidth}}mm;text-align:center'>
        	{% if pdfLanguage=='fr' %}
        	Conditions générales applicables pour la vente et la location de nos produits en annexe de cette offre.
        	{% else %}
        	Algemene voorwaarden die geldig zijn voor de aankoop of huur van onze produkten zoals vermeld bij de annex van deze offerte.
        	{% endif %}
        </td>
      </tr>
      <tr>
  ...
  <table style="width:{{mWidth}}mm;" >
    <tr>
      ...
      <td style='padding-top:45mm;vertical-align:top'>{{client.title}} {{client.firstname}} {{client.lastname}}<br/>
        <br/>
        {{client.number}}  {{client.address}}<br/>{{client.zip}} {{client.city}}<br/>{{client.country}}<br/>
        {% if client.type=='cie' %}<br/><br/>TVA: {{client.vat}} {% endif %}</td>
    </tr>
  </table>
  <br/>
  <table style="width:{{mWidth}}mm" >
    <tr>
      <td style='width:{{mWidth}}mm;background-color:#ededed;text-align:center'><b>
      	{% if offre.offreType=='rent' and pdfLanguage=='fr' %}
      	Offre de location
      	{% elseif offre.offreType=='sell' and pdfLanguage=='fr' %}
      	Offre de vente
      	{% endif %}
      	</b></td>
    </tr>
 ...
 <br/>
  <b><u>Lieu :</u></b>
  <p> {{offre.number}}  {{offre.address}}<br/>{{offre.zip}} {{offre.city}}<br/>{{offre.country}} </p>
  <br/>
  <b><u>Timing :</u></b>
  <ul>
    <li>Montage : Du {{planning.build.formatedStartDate}} au {{planning.build.formatedEndDate}}</li>
    <li>Jour(s) de votre evénement : du {{planning.build.formatedEndDate}} au {{planning.unbuild.formatedStartDate}}</li>
    <li>Démontage : Du {{planning.unbuild.formatedStartDate}} au {{planning.unbuild.formatedEndDate}}</li>
  </ul>
  <br/>
  <b><u>Proposition de location de tente(s) :</u></b> {% for t in tents.currentOffre %} {{t.name}}{% endfor %} <br/>
...
<page>
  ...
  <table style="width:{{mWidth}}mm" >
    <tr>
      ...
      <td style="width:90mm;vertical-align:bottom;text-align:right">Offre {offreRef} (p2)</td>
    </tr>
  </table>
  <br/>
  <table style="width:{{mWidth}}mm" >
  ...
  <b><u>Conditions :</u></b>
  <p>{conditions}</p>
  <p> <b>Nos prix s'entendent hors TVA</b> <br/>
    Validité de cette offre: 30 jours date de l'offre </p>
  <br />
  <br />
      ...
      <td style="width:180mm;vertical-align:top;font-size:6pt;text-align:justify"> Conditions générales applicables pour la vente et la location de nos produits
        ...
        <p> <b>7.	Annulations</b><br/>
          ...
          * payer simultanément à titre de dommage et intérêt :
          ...
          Dans les contrats conclus avec les consommateurs, le loueur pourra annuler le contrat dans les mêmes conditions. </p>
        <p> <b>8.	Responsabilité des parties</b><br/>
        ...
        <p> <b>9.	Montage et terrains</b><br/>
          ...
          Lors du démontage du matériel, tout retard dû au non dégagement complet de celui-ci est facturé (prolongation de location, déplacements supplémentaires, allongement des heures de travail…) </p>
        <p> <b>10.	Matériel loué</b><br/>
        ...
        <p> <b>11.	Délais - Force majeure</b><br/>
          ...
          Les présentes conditions générales de location sont également disponibles sur le site www.organic.be. </p>
        <p> <b>12.	Juridiction</b><br/>
          En cas de contestation, seront seuls compétents les tribunaux de Nivelles et la loi belge. </p></td>
    </tr>
  </table>
</page>
