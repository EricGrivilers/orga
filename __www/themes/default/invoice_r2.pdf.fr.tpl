 ...
 <table style="width:{{mWidth}}mm;" >
    ...
    <tr>
      <td style='width:100mm;vertical-align:top'><img src="themes/default/images/logo.png"><br/>
        ...
        Zaventem, le {{invoice.r2RDate}}<br/>
        <br/>
       </td>
      <td style='vertical-align:top;padding-top:4mm'><span style="color:#E1001A;font-weight:bold">2nd RAPPEL - 
...
<p>La facture n°{{invoice.reference}} n’est pas payée à ce jour, la date d’échéance étant datée au {{invoice.invoiceDate}}.</p>
