...
/* invoice.pdf.nl.tpl */
class __TwigTemplate_7a16ccf5e67d07519ebba47ad3b508d9 extends Twig_Template
{
...
\t<page_footer>
    <table style=\"width:";
      ...
      <tr>
        ...
        // line 5
        echo (isset($context['mWidth']) ? $context['mWidth'] : null);
        echo "mm;text-align:center'>Algemene voorwaarden die geldig zijn voor de aankoop of huur van onze produkten zoals vermeld bij de annex van deze factuur.</td>
      </tr>
      <tr>
        <td style='width:";
        // line 8
...
\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t<th style=\"width:140mm;text-align:left;background-color:#ededed\">Beschrijving</th>
\t\t\t\t\t\t\t<th style=\"width:40mm;text-align:right;background-color:#ededed\">Bedrag excl BTW</th>
\t\t\t\t\t\t</tr>
\t\t\t\t\t</thead>
\t\t\t\t\t<tbody>
\t\t\t\t\t\t";
...
\t\t\t\t\t\t
\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t<td style=\"text-align:right;background-color:#ededed;\">TOTAAL incl BTW :</td>
...
\t\t\t\t\t\t\t<td style='width:19mm'>";
            ...
            echo " %</td>
\t\t\t\t\t\t\t<td style=\"width:60mm;text-align:right;\">TOTAAL incl BTW : ";
            // line 112
...
";
  ...
  ";
        ...
        if (($this->getAttribute((isset($context['invoice']) ? $context['invoice'] : null), "conditions1", array(), "any", false) != "")) {
            // line 212
            echo "  Betalingsvoorwaarden: contant<br/>
Communicatie: factuur nummer<br/>
  ";
        ...
        if (($this->getAttribute((isset($context['invoice']) ? $context['invoice'] : null), "conditions2", array(), "any", false) != "")) {
            // line 216
            echo "   De betaling van uw voorschot, bevestigt uw bestelling.<br/>
  ";
        }
        // line 218
        echo "   ";
 ...
 <table style=\"width:";
    ...
    <tr>
      <td style='width:";
        // line 233
        echo (isset($context['mWidth']) ? $context['mWidth'] : null);
        echo "mm;background-color:#ededed;text-align:center'><b>ORGANIC SA/NV.  Algemene voorwaarden </b></td>
    </tr>
  </table>
<table style=\"width:";
        // line 236
