...
use Caravane\CKEditorBundle\Exception\DependencyInjectionException,
 ...
 */
class CaravaneCKEditorExtension extends Extension
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function register(array $config, ContainerBuilder $container)
    {
        ...
        $container->setParameter('twig.form.resources', array_merge(
            ...
            array('CaravaneCKEditorBundle:Form:ckeditor_widget.html.twig')
        ));
    ...
    protected function registerConfigs(array $config, ContainerBuilder $container)
    {
        ...
        $definition = $container->getDefinition('caravane_ck_editor.config_manager');
