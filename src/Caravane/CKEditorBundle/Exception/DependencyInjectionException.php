...
class DependencyInjectionException extends Exception
{
     ...
     *
     * @return \Caravane\CKEditorBundle\Exception\DependencyInjectionException The "INVALID TOOLBAR ITEM" exception.
     */
     ...
     *
     * @return \Caravane\CKEditorBundle\Exception\DependencyInjectionException The "INVALID TOOLBAR" exception.
     */
