...
/* CaravaneOrganicBundle:Condition:edit.html.twig */
class __TwigTemplate_7515ca021f4b504f1c40bb66d79a24bba926b3ccfd0037092fc13e1d77bf9d1a extends Twig_Template
{
    ...
    {
        // line 4
        echo "<h1>Condition edit</h1>

    <form action=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("condition_update", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "CaravaneOrganicBundle:Condition:edit.html.twig";
    }
