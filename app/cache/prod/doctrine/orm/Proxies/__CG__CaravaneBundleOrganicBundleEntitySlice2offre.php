 ...
 */
class Slice2offre extends \Caravane\Bundle\OrganicBundle\Entity\Slice2offre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'sliceid', 'slice', 'priceht', 'comments', 'status', 'offreid');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Slice2offre $proxy) {
