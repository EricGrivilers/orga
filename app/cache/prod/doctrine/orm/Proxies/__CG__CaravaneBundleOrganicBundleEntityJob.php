 ...
 */
class Job extends \Caravane\Bundle\OrganicBundle\Entity\Job implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'eventdate', 'insertdate', 'updatedate', 'reference', 'offretype', 'planningcomments', 'offrecomments', 'surface', 'startbuild', 'endbuild', 'buildnotes', 'unbuildnotes', 'requestdate', 'status', 'pricetype', 'price', 'pricecomments', 'conditions', 'conditionsslices', 'tents', 'tentscomments', 'address', 'number', 'zip', 'city', 'country', 'contact', 'phone', 'phone2', 'mobile', 'fax', 'email', 'url', 'comments', 'public', 'issue', 'language', 'userid', 'clientid', 'invoiceid', 'offreid', 'tents2job', 'plannings', 'products', 'slices', 'totalSlice', 'totalSlicePriceht', 'document', 'comment', 'files');
        }
    ...
    public function setBuildnotes($buildnotes)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBuildnotes', array($buildnotes));

        return parent::setBuildnotes($buildnotes);
    }
    ...
    public function getBuildnotes()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBuildnotes', array());

        return parent::getBuildnotes();
    }
    ...
    public function setUnbuildnotes($unbuildnotes)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUnbuildnotes', array($unbuildnotes));

        return parent::setUnbuildnotes($unbuildnotes);
    }
    ...
    public function getUnbuildnotes()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUnbuildnotes', array());

        return parent::getUnbuildnotes();
    }
    ...
    public function addInvoiceid(\Caravane\Bundle\OrganicBundle\Entity\Invoice $invoiceid)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addInvoiceid', array($invoiceid));

        return parent::addInvoiceid($invoiceid);
    }
    ...
    public function removeInvoiceid(\Caravane\Bundle\OrganicBundle\Entity\Invoice $invoiceid)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeInvoiceid', array($invoiceid));

        return parent::removeInvoiceid($invoiceid);
    }
