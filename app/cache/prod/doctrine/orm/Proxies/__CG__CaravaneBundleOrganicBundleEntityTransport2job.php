 ...
 */
class Transport2job extends \Caravane\Bundle\OrganicBundle\Entity\Transport2job implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'quantity', 'priceht', 'jobid');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Transport2job $proxy) {
