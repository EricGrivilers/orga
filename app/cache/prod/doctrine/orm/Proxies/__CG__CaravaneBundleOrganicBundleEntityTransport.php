 ...
 */
class Transport extends \Caravane\Bundle\OrganicBundle\Entity\Transport implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'cost', 'distance', 'zip');
        }
