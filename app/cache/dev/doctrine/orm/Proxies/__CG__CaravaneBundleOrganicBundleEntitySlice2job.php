 ...
 */
class Slice2job extends \Caravane\Bundle\OrganicBundle\Entity\Slice2job implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'sliceid', 'slice', 'priceht', 'comments', 'status', 'jobid', 'invoiceid');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Slice2job $proxy) {
