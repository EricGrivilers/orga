 ...
 */
class Transport2invoice extends \Caravane\Bundle\OrganicBundle\Entity\Transport2invoice implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'quantity', 'priceht', 'invoiceid');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Transport2invoice $proxy) {
