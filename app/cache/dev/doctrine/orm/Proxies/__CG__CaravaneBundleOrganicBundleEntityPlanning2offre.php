 ...
 */
class Planning2offre extends \Caravane\Bundle\OrganicBundle\Entity\Planning2offre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'planningtype', 'startdate', 'enddate', 'etat', 'userid', 'offreid');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Planning2offre $proxy) {
