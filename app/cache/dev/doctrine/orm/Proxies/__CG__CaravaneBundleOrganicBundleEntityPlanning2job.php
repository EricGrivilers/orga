 ...
 */
class Planning2job extends \Caravane\Bundle\OrganicBundle\Entity\Planning2job implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'planningtype', 'startdate', 'enddate', 'etat', 'userid', 'jobid');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Planning2job $proxy) {
