 ...
 */
class PlanningLogs extends \Caravane\Bundle\OrganicBundle\Entity\PlanningLogs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'jobid', 'offreid', 'planningtype', 'startdate', 'enddate', 'insertdate', 'updateby', 'userid');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PlanningLogs $proxy) {
    ...
    public function setUpdateby($updateby)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUpdateby', array($updateby));
    ...
    public function getUpdateby()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUpdateby', array());
