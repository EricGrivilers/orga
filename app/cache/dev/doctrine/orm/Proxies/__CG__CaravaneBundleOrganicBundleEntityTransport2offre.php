 ...
 */
class Transport2offre extends \Caravane\Bundle\OrganicBundle\Entity\Transport2offre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'quantity', 'priceht', 'offreid');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Transport2offre $proxy) {
