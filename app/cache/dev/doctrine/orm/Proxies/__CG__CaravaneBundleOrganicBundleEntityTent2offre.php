 ...
 */
class Tent2offre extends \Caravane\Bundle\OrganicBundle\Entity\Tent2offre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Tent2offre $proxy) {
